...
pro_terran_aggregated_data = pro_terran_df.groupby('second')['tech_amount'].quantile(0.20)[:-50]
...
pro_zerg_aggregated_data = pro_zerg_df.groupby('second')['tech_amount'].quantile(0.20)[:-50]
...
pro_protoss_aggregated_data = pro_protoss_df.groupby('second')['tech_amount'].quantile(0.20)[:-50]
