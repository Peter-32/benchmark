...
my_terran_aggregated_data = my_terran_df.groupby('second')['inject_count'].quantile(0.80)
...
my_zerg_aggregated_data = my_zerg_df.groupby('second')['inject_count'].quantile(0.80)
...
my_protoss_aggregated_data = my_protoss_df.groupby('second')['inject_count'].quantile(0.80)
