...
plt.savefig("../data/output/my_larva_born_zvt_benchmark.png")
plt.clf()
...
plt.savefig("../data/output/my_larva_born_zvz_benchmark.png")
plt.clf()
...
plt.savefig("../data/output/my_larva_born_zvp_benchmark.png")
plt.clf()
