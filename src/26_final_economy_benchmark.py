...
plt.savefig("../data/output/my_economy_zvt_benchmark.png")
plt.clf()
...
plt.savefig("../data/output/my_economy_zvz_benchmark.png")
plt.clf()
...
plt.savefig("../data/output/my_economy_zvp_benchmark.png")
plt.clf()
